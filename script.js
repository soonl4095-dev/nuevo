// ==========================================
        ...
        // ==========================================
        // ==========================================
        // FALLBACK DE IMÁGENES DE CERTIFICADOS
        // Si una imagen no carga (ruta incorrecta, archivo no subido, etc.),
        // en vez de dejar el ícono roto del navegador, mostramos un link
        // limpio "Ver certificado" que apunta al mismo archivo — así, si
        // luego se sube correctamente, el link ya funciona sin tocar nada más.
        // ==========================================
        function handleCertImageError(imgEl) {
            const container = imgEl.closest('.cert-image-container');
            if (!container) return;
            const src = imgEl.getAttribute('src');
            const alt = imgEl.getAttribute('alt') || 'Certificado';
            container.innerHTML = `
                <a href="${src}" target="_blank" class="cert-fallback-link" title="${alt}">
                    <span class="cert-fallback-icon">📄</span>
        ...
        const data = {
            senati: {
                ...
                sections: {
                    ...
                    certificados: { icon: "🏆", title: "Certificados", content: `<div class="year-header">📅 Año 2023</div><div class="block-card"><div class="cert-image-container"><a href="https://senatipe-my.sharepoint.com/:b:/g/personal/1507001_senati_pe/IQCAyAqjAdU1QZOKJd3cSIcgAWZLtS6nMQOZpJ1W5ve5SKY?e=uMve7h" target="_blank" class="cert-fallback-link" title="Certificado Get Connected"><span class="cert-fallback-icon">📄</span><span>Ver certificado</span></a></div><span class="block-tag">Cisco Networking Academy</span><h4>Get Connected</h4><p>Certificado de logro (16 Feb 2023). Fundamentos de conectividad y primeros pasos en redes.</p></div><div class="block-card"><div class="cert-image-container"><a href="https://senatipe-my.sharepoint.com/:b:/g/personal/1507001_senati_pe/IQAjNwaU5194QKTNgHdxE1JEARJHloAAnmIXkYli1Avj0Yo?e=90kFED" target="_blank" class="cert-fallback-link" title="Certificado Introduction to IoT"><span class="cert-fallback-icon">📄</span><span>Ver certificado</span></a></div><span class="block-tag">Cisco Networking Academy</span><h4>Introduction to IoT</h4><p>Certificado de logro (21 Feb 2023). Introducción al Internet de las Cosas y sus aplicaciones.</p></div><div class="block-card"><div class="cert-image-container"><a href="https://senatipe-my.sharepoint.com/:b:/g/personal/1507001_senati_pe/IQAjCZWD-AQlQY31dKgs0XYKATt8V6Gw-tbUnW4AQxGyMxA?e=xLfcpb" target="_blank" class="cert-fallback-link" title="Certificado Entrepreneurship"><span class="cert-fallback-icon">📄</span><span>Ver certificado</span></a></div><span class="block-tag">Cisco Networking Academy</span><h4>Entrepreneurship</h4><p>Certificado de logro (28 Feb 2023). Fundamentos de emprendimiento y modelos de negocio tecnológico.</p></div><div class="block-card"><div class="cert-image-container"><a href="https://senatipe-my.sharepoint.com/:b:/g/personal/1507001_senati_pe/IQD_k_vAJCwrQpUKcBTEd0QnAWrXGYG3a0XUfTRlNh1SZsc?e=Hiajhn" target="_blank" class="cert-fallback-link" title="Certificado PCAP: Programming Essentials in Python"><span class="cert-fallback-icon">📄</span><span>Ver certificado</span></a></div><span class="block-tag">Cisco / OpenEDG</span><h4>PCAP: Programming Essentials in Python</h4><p>Certificado de logro (29 May 2023). Conceptos universales de programación, sintaxis de Python, OOP y resolución de problemas de implementación.</p></div><div class="block-card"><div class="cert-image-container"><a href="https://senatipe-my.sharepoint.com/:b:/g/personal/1507001_senati_pe/IQB4AAjhnaDrT6b_PzVlYnbYARUyaV4u2R7Lh_RA679bK4I?e=r8g8Cg" target="_blank" class="cert-fallback-link" title="Certificado Networking Essentials"><span class="cert-fallback-icon">📄</span><span>Ver certificado</span></a></div><span class="block-tag">Cisco Networking Academy</span><h4>Networking Essentials</h4><p>Certificado de logro (01 Jun 2023). Fundamentos de redes: direccionamiento IP, medios de transmisión y dispositivos de red.</p></div><div class="block-card"><div class="cert-image-container"><a href="https://senatipe-my.sharepoint.com/:b:/g/personal/1507001_senati_pe/IQBu-rbTclTaSKxyGtocH7pLAWaHZollH9VlyZVPPayI9E4?e=SIWKwz" target="_blank" class="cert-fallback-link" title="Certificado CCNAv7: Introduction to Networks"><span class="cert-fallback-icon">📄</span><span>Ver certificado</span></a></div><span class="block-tag">Cisco</span><h4>CCNAv7: Introduction to Networks</h4><p>Certificado de logro (22 Nov 2023). Arquitectura OSI y TCP/IP, subneteo y configuración básica de routers y switches.</p></div><div class="block-card"><div class="cert-image-container"><a href="https://senatipe-my.sharepoint.com/:b:/g/personal/1507001_senati_pe/IQCAxGoiCZVkQqYn9JLyckxcATHZH_xBgy9XoI7mE8ttnL8?e=SAkIZV" target="_blank" class="cert-fallback-link" title="Certificado IT Essentials: PC Hardware and Software"><span class="cert-fallback-icon">📄</span><span>Ver certificado</span></a></div><span class="block-tag">Cisco Networking Academy</span><h4>IT Essentials: PC Hardware and Software</h4><p>Certificado de finalización (22 Nov 2023). Ensamblaje, reparación y actualización de PCs. Solución de problemas de SO Windows, redes móviles y seguridad básica.</p></div><div class="block-card"><div class="cert-image-container"><a href="https://senatipe-my.sharepoint.com/:b:/g/personal/1507001_senati_pe/IQCcSG6uqx4JR5AnGV60FSB3AW5OEG2ZF5E0Ns2tGBUpg1w?e=ihZJDe" target="_blank" class="cert-fallback-link" title="Certificado CCNAv7: Switching, Routing, and Wireless Essentials"><span class="cert-fallback-icon">📄</span><span>Ver certificado</span></a></div><span class="block-tag">Cisco</span><h4>CCNAv7: Switching, Routing, and Wireless Essentials</h4><p>Certificado de logro (23 Nov 2023). Configuración de VLANs, enrutamiento inter-VLAN, protocolos de enrutamiento dinámico y redes inalámbricas.</p></div><div class="block-card"><div class="cert-image-container"><a href="https://senatipe-my.sharepoint.com/:b:/g/personal/1507001_senati_pe/IQCow_LadQhKRIUgNvqQ_bdhAU2-w-2kvBaT8YQMrLVYWPM?e=lrgLjJ" target="_blank" class="cert-fallback-link" title="Certificado Cybersecurity Essentials"><span class="cert-fallback-icon">📄</span><span>Ver certificado</span></a></div><span class="block-tag">Cisco Networking Academy</span><h4>Cybersecurity Essentials</h4><p>Certificado de logro (24 Nov 2023). Profundización en amenazas, vulnerabilidades y técnicas de defensa de redes.</p></div><div class="year-header">📅 Año 2025</div><div class="block-card"><div class="cert-image-container"><a href="https://senatipe-my.sharepoint.com/:b:/g/personal/1507001_senati_pe/IQD9nrVlv7PYSqipS31s7SqjAXFozM3mDkwUCzqia8bwY6U?e=pseWO6" target="_blank" class="cert-fallback-link" title="Certificado Introducción a la Ciberseguridad"><span class="cert-fallback-icon">📄</span><span>Ver certificado</span></a></div><span class="block-tag">Cisco Networking Academy</span><h4>Introducción a la Ciberseguridad</h4><p>Certificado de logro (15 Mar 2025). Conceptos base de ciberseguridad: amenazas, vulnerabilidades y buenas prácticas de protección.</p></div><div class="block-card"><div class="cert-image-container"><a href="https://senatipe-my.sharepoint.com/:b:/g/personal/1507001_senati_pe/IQBGQ7EI5BSDRZ741IpIpRSyAQWSe8kSCRmdevFp6VZqbP4?e=MLJvcO" target="_blank" class="cert-fallback-link" title="Certificado Fundamentos de Python 1"><span class="cert-fallback-icon">📄</span><span>Ver certificado</span></a></div><span class="block-tag">Cisco Networking Academy</span><h4>Fundamentos de Python 1</h4><p>Certificado de logro (15 Mar 2025). Sintaxis básica de Python, estructuras de control y fundamentos de programación.</p></div><div class="year-header">📅 Año 2026</div><div class="block-card"><div class="cert-image-container"><a href="https://senatipe-my.sharepoint.com/:b:/g/personal/1507001_senati_pe/IQA5hVunyVvQT7Bk1304slwKAeZ6o-2MjoHOjPeBoBw6OOw?e=8oBFo2" target="_blank" class="cert-fallback-link" title="Certificado Hacker Ético"><span class="cert-fallback-icon">📄</span><span>Ver certificado</span></a></div><span class="block-tag">SENATI - Sede Independencia</span><h4>Hacker Ético</h4><p>Certificado de logro (03 May 2026). Técnicas de hacking ético y pruebas de penetración, ofrecido por SENATI a través de Cisco Networking Academy.</p></div>` },
