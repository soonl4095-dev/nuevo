        ...
        const data = {
            senati: {
                ...
                sections: {
                    ...
                    certificados: { icon: "🏆", title: "Certificados", content: `<div class="cert-subsection-title">🎓 Certificados de Cursos</div><div class="year-header">📅 Año 2023</div><div class="block-card"><div class="cert-image-container"><a href="certs/get-connected.jpg" target="_blank"><img src="certs/get-connected.jpg" alt="Certificado Get Connected" class="cert-image" loading="lazy" onerror="this.closest('.cert-image-container').innerHTML='<span style=\'color:#94a3b8;font-family:var(--font-mono);font-size:0.75rem;padding:10px;text-align:center;\'>Imagen no disponible</span>'"></a><span class="cert-view-icon">🔍</span></div><span class="block-tag">Cisco Networking Academy</span><h4>Get Connected</h4><p>Fecha de finalización: 16 Feb 2023. Introducción a los fundamentos de conectividad, internet y dispositivos en red.</p></div><div class="block-card"><div class="cert-image-container"><a href="certs/introduction-iot.jpg" target="_blank"><img src="certs/introduction-iot.jpg" alt="Certificado Introduction to IoT" class="cert-image" loading="lazy" onerror="this.closest('.cert-image-container').innerHTML='<span style=\'color:#94a3b8;font-family:var(--font-mono);font-size:0.75rem;padding:10px;text-align:center;\'>Imagen no disponible</span>'"></a><span class="cert-view-icon">🔍</span></div><span class="block-tag">Cisco Networking Academy</span><h4>Introduction to IoT</h4><p>Fecha de finalización: 21 Feb 2023. Fundamentos del Internet de las Cosas (IoT) y sus aplicaciones prácticas.</p></div><div class="block-card"><div class="cert-image-container"><a href="certs/entrepreneurship.jpg" target="_blank"><img src="certs/entrepreneurship.jpg" alt="Certificado Entrepreneurship" class="cert-image" loading="lazy" onerror="this.closest('.cert-image-container').innerHTML='<span style=\'color:#94a3b8;font-family:var(--font-mono);font-size:0.75rem;padding:10px;text-align:center;\'>Imagen no disponible</span>'"></a><span class="cert-view-icon">🔍</span></div><span class="block-tag">Cisco Networking Academy</span><h4>Entrepreneurship</h4><p>Fecha de finalización: 28 Feb 2023. Fundamentos de emprendimiento y modelos de negocio aplicados a tecnología.</p></div><div class="block-card"><div class="cert-image-container"><a href="certs/cybersecurity-essentials-1.jpg" target="_blank"><img src="certs/cybersecurity-essentials-1.jpg" alt="Certificado Cybersecurity Essentials" class="cert-image" loading="lazy" onerror="this.closest('.cert-image-container').innerHTML='<span style=\'color:#94a3b8;font-family:var(--font-mono);font-size:0.75rem;padding:10px;text-align:center;\'>Imagen no disponible</span>'"></a><span class="cert-view-icon">🔍</span></div><span class="block-tag">Cisco Networking Academy</span><h4>Cybersecurity Essentials</h4><p>Fecha de finalización: 14 Mar 2023. Fundamentos de ciberseguridad: amenazas, vulnerabilidades y buenas prácticas de protección.</p></div><div class="block-card"><div class="cert-image-container"><a href="certs/pcap-python.jpg" target="_blank"><img src="certs/pcap-python.jpg" alt="Certificado Partner: PCAP - Programming Essentials in Python" class="cert-image" loading="lazy" onerror="this.closest('.cert-image-container').innerHTML='<span style=\'color:#94a3b8;font-family:var(--font-mono);font-size:0.75rem;padding:10px;text-align:center;\'>Imagen no disponible</span>'"></a><span class="cert-view-icon">🔍</span></div><span class="block-tag">Cisco Networking Academy / OpenEDG</span><h4>Partner: PCAP - Programming Essentials in Python</h4><p>Fecha de finalización: 29 May 2023. Conceptos universales de programación, sintaxis de Python, OOP y resolución de problemas de implementación.</p></div><div class="block-card"><div class="cert-image-container"><a href="certs/networking-essentials.jpg" target="_blank"><img src="certs/networking-essentials.jpg" alt="Certificado Networking Essentials" class="cert-image" loading="lazy" onerror="this.closest('.cert-image-container').innerHTML='<span style=\'color:#94a3b8;font-family:var(--font-mono);font-size:0.75rem;padding:10px;text-align:center;\'>Imagen no disponible</span>'"></a><span class="cert-view-icon">🔍</span></div><span class="block-tag">Cisco Networking Academy</span><h4>Networking Essentials</h4><p>Fecha de finalización: 01 Jun 2023. Fundamentos de redes: modelos OSI/TCP-IP, direccionamiento IP y medios de transmisión.</p></div><div class="block-card"><div class="cert-image-container"><a href="certs/it-essentials.jpg" target="_blank"><img src="certs/it-essentials.jpg" alt="Certificado IT Essentials: PC Hardware and Software" class="cert-image" loading="lazy" onerror="this.closest('.cert-image-container').innerHTML='<span style=\'color:#94a3b8;font-family:var(--font-mono);font-size:0.75rem;padding:10px;text-align:center;\'>Imagen no disponible</span>'"></a><span class="cert-view-icon">🔍</span></div><span class="block-tag">Cisco Networking Academy</span><h4>IT Essentials: PC Hardware and Software</h4><p>Fecha de finalización: 22 Nov 2023. Ensamblaje, reparación y actualización de PCs. Solución de problemas de SO Windows, redes y seguridad básica.</p></div><div class="block-card"><div class="cert-image-container"><a href="certs/ccna-introduction-networks.jpg" target="_blank"><img src="certs/ccna-introduction-networks.jpg" alt="Certificado CCNAv7: Introduction to Networks" class="cert-image" loading="lazy" onerror="this.closest('.cert-image-container').innerHTML='<span style=\'color:#94a3b8;font-family:var(--font-mono);font-size:0.75rem;padding:10px;text-align:center;\'>Imagen no disponible</span>'"></a><span class="cert-view-icon">🔍</span></div><span class="block-tag">Cisco Networking Academy</span><h4>CCNAv7: Introduction to Networks</h4><p>Fecha de finalización: 22 Nov 2023. Arquitectura OSI y TCP/IP, subneteo y configuración básica de routers y switches.</p></div><div class="block-card"><div class="cert-image-container"><a href="certs/ccna-srwe.jpg" target="_blank"><img src="certs/ccna-srwe.jpg" alt="Certificado CCNAv7: Switching, Routing, and Wireless Essentials" class="cert-image" loading="lazy" onerror="this.closest('.cert-image-container').innerHTML='<span style=\'color:#94a3b8;font-family:var(--font-mono);font-size:0.75rem;padding:10px;text-align:center;\'>Imagen no disponible</span>'"></a><span class="cert-view-icon">🔍</span></div><span class="block-tag">Cisco Networking Academy</span><h4>CCNAv7: Switching, Routing, and Wireless Essentials</h4><p>Fecha de finalización: 23 Nov 2023. Configuración de switches, VLANs, enrutamiento entre VLAN y fundamentos de redes inalámbricas.</p></div><div class="block-card"><div class="cert-image-container"><a href="certs/cybersecurity-essentials-2.jpg" target="_blank"><img src="certs/cybersecurity-essentials-2.jpg" alt="Certificado Cybersecurity Essentials" class="cert-image" loading="lazy" onerror="this.closest('.cert-image-container').innerHTML='<span style=\'color:#94a3b8;font-family:var(--font-mono);font-size:0.75rem;padding:10px;text-align:center;\'>Imagen no disponible</span>'"></a><span class="cert-view-icon">🔍</span></div><span class="block-tag">Cisco Networking Academy</span><h4>Cybersecurity Essentials</h4><p>Fecha de finalización: 24 Nov 2023. Recertificación: amenazas, vulnerabilidades y buenas prácticas de protección en ciberseguridad.</p></div><div class="year-header">📅 Año 2025</div><div class="block-card"><div class="cert-image-container"><a href="certs/intro-ciberseguridad.jpg" target="_blank"><img src="certs/intro-ciberseguridad.jpg" alt="Certificado Introducción a la Ciberseguridad" class="cert-image" loading="lazy" onerror="this.closest('.cert-image-container').innerHTML='<span style=\'color:#94a3b8;font-family:var(--font-mono);font-size:0.75rem;padding:10px;text-align:center;\'>Imagen no disponible</span>'"></a><span class="cert-view-icon">🔍</span></div><span class="block-tag">Cisco Networking Academy</span><h4>Introducción a la Ciberseguridad</h4><p>Fecha de finalización: 15 Mar 2025. Conceptos introductorios sobre amenazas cibernéticas, privacidad de datos y protección en línea.</p></div><div class="block-card"><div class="cert-image-container"><a href="certs/fundamentos-python-1.jpg" target="_blank"><img src="certs/fundamentos-python-1.jpg" alt="Certificado Fundamentos de Python 1" class="cert-image" loading="lazy" onerror="this.closest('.cert-image-container').innerHTML='<span style=\'color:#94a3b8;font-family:var(--font-mono);font-size:0.75rem;padding:10px;text-align:center;\'>Imagen no disponible</span>'"></a><span class="cert-view-icon">🔍</span></div><span class="block-tag">Cisco Networking Academy</span><h4>Fundamentos de Python 1</h4><p>Fecha de finalización: 15 Mar 2025. Primeros pasos en programación con Python: variables, estructuras de control y funciones básicas.</p></div><div class="year-header">📅 Año 2026</div><div class="block-card"><div class="cert-image-container"><a href="certs/ethical-hacker.jpg" target="_blank"><img src="certs/ethical-hacker.jpg" alt="Certificado Hacker Ético" class="cert-image" loading="lazy" onerror="this.closest('.cert-image-container').innerHTML='<span style=\'color:#94a3b8;font-family:var(--font-mono);font-size:0.75rem;padding:10px;text-align:center;\'>Imagen no disponible</span>'"></a><span class="cert-view-icon">🔍</span></div><span class="block-tag">SENATI - Sede Independencia</span><h4>Hacker Ético</h4><p>Fecha de finalización: 03 May 2026. Fundamentos de hacking ético: metodologías de pruebas de penetración y análisis de vulnerabilidades.</p></div><div class="cert-subsection-title">🎤 Certificados de Eventos</div><div class="block-card cert-placeholder"><p>Próximamente: certificados de charlas, webinars y eventos tecnológicos a los que asistí.</p></div>` },
