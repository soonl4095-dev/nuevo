        ...
        const data = {
            senati: {
                ...
                sections: {
                    ...
                    certificados: { icon: "🏆", title: "Certificados", content: `<div class="year-header">📅 Año 2023</div><div class="block-card"><div class="cert-image-container"><a href="https://via.placeholder.com/800x600/0f172a/00f2ff?text=Certificado+PCAP+Python" target="_blank"><img src="https://via.placeholder.com/400x250/0f172a/00f2ff?text=PCAP+Python" alt="Certificado PCAP Python" class="cert-image" loading="lazy" onerror="this.closest('.cert-image-container').innerHTML='<span style=\\'color:#94a3b8;font-family:var(--font-mono);font-size:0.75rem;padding:10px;text-align:center;\\'>Imagen no disponible</span>'"></a><span class="cert-view-icon">🔍</span></div><span class="block-tag">Cisco / OpenEDG</span><h4>PCAP: Programming Essentials in Python</h4><p>Certificado de logro (29 May 2023). Conceptos universales de programación, sintaxis de Python, OOP y resolución de problemas de implementación.</p></div><div class="block-card"><div class="cert-image-container"><a href="https://via.placeholder.com/800x600/0f172a/00f2ff?text=Certificado+IT+Essentials" target="_blank"><img src="https://via.placeholder.com/400x250/0f172a/00f2ff?text=IT+Essentials" alt="Certificado IT Essentials" class="cert-image" loading="lazy" onerror="this.closest('.cert-image-container').innerHTML='<span style=\\'color:#94a3b8;font-family:var(--font-mono);font-size:0.75rem;padding:10px;text-align:center;\\'>Imagen no disponible</span>'"></a><span class="cert-view-icon">🔍</span></div><span class="block-tag">Cisco Networking Academy</span><h4>IT Essentials</h4><p>Certificado de finalización (22 Nov 2023). Ensamblaje, reparación y actualización de PCs. Solución de problemas de SO Windows, redes móviles y seguridad básica.</p></div><div class="year-header">📅 Año 2024</div><div class="block-card"><div class="cert-image-container"><a href="https://via.placeholder.com/800x600/0f172a/00f2ff?text=Certificado+CCNAv7" target="_blank"><img src="https://via.placeholder.com/400x250/0f172a/00f2ff?text=CCNAv7" alt="Certificado CCNAv7" class="cert-image" loading="lazy" onerror="this.closest('.cert-image-container').innerHTML='<span style=\\'color:#94a3b8;font-family:var(--font-mono);font-size:0.75rem;padding:10px;text-align:center;\\'>Imagen no disponible</span>'"></a><span class="cert-view-icon">🔍</span></div><span class="block-tag">Cisco</span><h4>CCNAv7: Introduction to Networks</h4><p>Arquitectura OSI y TCP/IP, subneteo y configuración básica de routers y switches.</p></div><div class="block-card"><div class="cert-image-container"><a href="https://via.placeholder.com/800x600/0f172a/00f2ff?text=Certificado+CyberOps" target="_blank"><img src="https://via.placeholder.com/400x250/0f172a/00f2ff?text=CyberOps" alt="Certificado CyberOps" class="cert-image" loading="lazy" onerror="this.closest('.cert-image-container').innerHTML='<span style=\\'color:#94a3b8;font-family:var(--font-mono);font-size:0.75rem;padding:10px;text-align:center;\\'>Imagen no disponible</span>'"></a><span class="cert-view-icon">🔍</span></div><span class="block-tag">Cisco</span><h4>CyberOps Associate</h4><p>Operaciones de ciberseguridad. Monitoreo de tráfico y respuesta a incidentes.</p></div>` },
